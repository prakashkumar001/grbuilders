...
public class FloorPlan  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        floor.add("C FIRST FLOOR");
        floor.add("C SECOND FLOOR");
        floor.add("C SLIT FLOOR");
        floor.add("D & E FIRST FLOOR");
        floor.add("D & E SECOND FLOOR");
        floor.add("D & E SLIT FLOOR");
    ...
    public class CustomPagerAdapter extends PagerAdapter {
        ...
        public CustomPagerAdapter(Context context) {
            mContext = context;
            drawables.add(R.drawable.vr_groundfloor);
             drawables.add(R.drawable.vr_firstfloor);
            drawables.add(R.drawable.vr_secondfloor);
            drawables.add(R.drawable.vr_c_firstfloor);
            drawables.add(R.drawable.vr_csecondflor);
            drawables.add(R.drawable.vr_cslitfloor);
            drawables.add(R.drawable.vr_de_firstfloor);
            drawables.add(R.drawable.vr_de_secondfloor);
            drawables.add(R.drawable.vr_de_slitfloor);
