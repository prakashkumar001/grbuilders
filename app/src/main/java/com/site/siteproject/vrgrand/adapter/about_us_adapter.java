...
public class about_us_adapter extends RecyclerView.Adapter<about_us_adapter.MyViewHolder> {
    ...
    GlobalClass globalClass;
      ...
      String[] contents={"VR Grand Foundation’s Private Limited (NFPL) saw its beginning that reflected their penchant to provide quality realty solutions, and that aimed at creating homes and not just houses for their clients. Their keen eye for detail and expertise with the intricacies of construction has brought over 60 prestigious residential projects to the firm’s dossier.","Incorporated in the year 2003, VR Grand Foundations has offered exceptional real estate developments over the years that adorn the city’s magnificent skyline.","Guided by integrity, innovation, quality and high service standards, VR Grand Foundations has grown momentously to attain a distinguished position of leadership in the real estate industry by successfully crafting many landmark projects across the city. Each of the VR Grand projects stands apart in their aesthetic design, impeccable quality and enticing features that lend exceptional value and privilege to those who own them."};
