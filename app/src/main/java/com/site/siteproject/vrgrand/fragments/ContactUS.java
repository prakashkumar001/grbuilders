...
public class ContactUS extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i=new Intent(com.site.siteproject.vrgrand.fragments.ContactUS.this, MainActivity.class);
        startActivity(i);
        ActivityCompat.finishAffinity(com.site.siteproject.vrgrand.fragments.ContactUS.this);
    }
