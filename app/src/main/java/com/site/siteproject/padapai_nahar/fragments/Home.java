package com.site.siteproject.padapai_nahar.fragments;
...
public class Home extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.padapai_home, container, false);
    ...
    void flatintialise()
    {
        ...
        for(int i = 0; i< flatnames.size(); i++){
            ...
            radioButton.setBackgroundResource(R.drawable.nahar_radio);
